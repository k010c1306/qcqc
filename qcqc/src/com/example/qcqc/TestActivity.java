...
public class TestActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout frame = (LinearLayout) findViewById(R.id.main_frame); // replace
																			// with
																			// id
																			// of
																			// your
	...
	private class TestMenu extends PieControl {
		...
		protected void populateMenu() {
			...
			PieItem minus = makeItem(android.R.drawable.ic_menu_preferences, 1);
			{
				...
				minus_sub.add(makeItem(android.R.drawable.ic_menu_preferences,
						1));
				minus_sub.add(makeItem(android.R.drawable.ic_menu_preferences,
						1));
		...
		public void setListeners() {
			this.setClickListener(plus_sub.get(0), new View.OnClickListener() {
				...
				public void onClick(View view) {
					Toast.makeText(getApplicationContext(), "Clicked plus 1",
			...
			this.setClickListener(plus_sub.get(1), new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					Toast.makeText(getApplicationContext(), "Clicked plus 2",
							Toast.LENGTH_SHORT).show();
				}
			});
			this.setClickListener(minus_sub.get(0), new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					Toast.makeText(getApplicationContext(), "Clicked minus 1",
							Toast.LENGTH_SHORT).show();
				}
			});
			this.setClickListener(minus_sub.get(1), new View.OnClickListener() {
				@Override
				public void onClick(View view) {
					Toast.makeText(getApplicationContext(), "Clicked minus 2",
							Toast.LENGTH_SHORT).show();
				}
			});
